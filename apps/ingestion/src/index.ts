...
import { detectProtocol, Redactor, AnthropicParser, OpenAIParser, StreamDelta } from '@the-soul/ingestion-core';
  ...
  async fetch(req) {
    ...
    if (url.pathname === '/ingest' && req.method === 'POST') {
      try {
        ...
        const sessionId = (rawEvent.headers && rawEvent.headers['x-session-id']) || rawEvent.event_id;
